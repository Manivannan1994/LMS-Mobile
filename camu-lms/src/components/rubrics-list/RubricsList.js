...
const RubricsListComponent = (props) => {
  ...
  const editRubrics = (oRubric) => {
    if((oRubric.asgnCnt && oRubric.asgnCnt > 1) || (oRubric.grdCnt && oRubric.grdCnt > 0)){
      ...
      history.push({ pathname: "/home-page/rubrics-edit", search:`?id=${oRubric._id}`, state: location.state });
    }
  }
  ...
  const goToRubricsCreation = () => {
    history.push({ pathname: "/home-page/rubrics-edit",state : location.state });
  }
  ...
  return (
    <div className="rubrics-list_box">
      <div className="rubrics-heading">
        <div className="cont-nav">
          ...
          <UIPerWrapper perCode={["rp_can_create_or_edit_lms_rubric"]}><div className="manual-setting">
              ...
              aRubrics.map((oRubric) => {
                return (
                  <div className="rubrics-lists">
                    <div className="rubrics-titles" onClick={()=>history.push({pathname:"/home-page/rubrics-view", search:`?id=${oRubric._id}`, state : location.state })}>
...
const TabNavigator = (props) => <RubricsListComponent {...props} />;
