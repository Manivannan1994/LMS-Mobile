...
const InputBox = lazy(() => import("../../src/components/input-box/InputBox"));
const CheckBox = lazy(() => import("../../src/components/checkbox/CheckBox"));
const oDumCrt = {
...
const RubricsEditComponent = (props) => {
   ...
   const discardChanges = () => {
      ...
      if(location.pathname ==="/Rubrics-create" && oSrchVal && oSrchVal.id){
         history.push({pathname:"/Rubrics-page"});
      }else if(location.pathname ==="/Rubrics-create") { // Navigation for rubrics list
         goToRubricsList();
      }
   }
            ...
            <div className="row m-0">
               ...
               <div className="col-6 p-0">
                  <div className="rubrics-publish_btn">
                     ...
                     {location.pathname === "/Rubrics-create" && 
